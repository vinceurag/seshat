defmodule Library.ProviderTest do
  ...
  describe "get_book_by_id/1" do
    test "returns book_not_found when book does not exist" do
      ...
      assert {:error, :book_not_found} = Provider.get_book_by_id(@id)
    end
  ...
  describe "get_books_by_title/1" do
    test "returns books_not_found when nothing was found" do
      ...
      assert {:error, :books_not_found} = Provider.get_books_by_title("dummy title")
    end
    ...
    test "returns a list of books" do
      ...
      assert {:ok,
              ...
              ]} = Provider.get_books_by_title("dummy title")
    end
  end
end
